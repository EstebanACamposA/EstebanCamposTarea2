...
namespace DataStructures
{
    namespace Lists
    {
        public class LinkedList<T>
        {
            ...
            public int len = 0;    //MAKE THIS PUBLIC SO THAT IList IS THE ACTUAL OBJECT TO INVOKE AND THIS IS JUST A BASE.
            ...
            public void DisplayAux(NodeLinkedList<T> first)
            {
                if (first != null)
                {
            ...
            public NodeLinkedList<T> FindLastNode(NodeLinkedList<T> first)
            {
                if (first.Next == null)
                {
                    return first;
            ...
            public NodeLinkedList<T>[] FindNodeAt(NodeLinkedList<T> first, int pos, int i, NodeLinkedList<T> previousNode)
            {
                if (i < pos)
                {
                    if (i == pos - 1)
            ...
            public int FindNodeAtValue(NodeLinkedList<T> first, T data, int i, NodeLinkedList<T> previousNode)
            {
                if (first == null)
                {
            ...
            public void AddNode(NodeLinkedList<T> node)
            {
                if (first == null)
                {
                    first = node;
            ...
            public void AddNodeAt(NodeLinkedList<T> node, int pos)
            {
